...
execute as @s[scores={Motionvalue=100..130}] at @s facing entity @p[limit=1,sort=nearest] eyes run tp @s ^ ^ ^-0.125
execute as @s[scores={Motionvalue=..100}] at @s facing entity @p[limit=1,sort=nearest] eyes run tp @s ^ ^ ^0.07
execute as @s[scores={Motionvalue=..75}] at @s facing entity @p[limit=1,sort=nearest] eyes run tp @s ^ ^ ^0.13
...
execute if entity @p[dx=0] positioned ^-0.75 ^-0.75 ^-0.75 if entity @s[dx=0] run kill @e[tag=Get_DPE,sort=nearest,limit=1]