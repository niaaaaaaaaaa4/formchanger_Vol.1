...
# ”下のブロックは　＜ツルハシ＞　で壊すことができる”
    execute if score @s CH_cooldown matches 0 unless predicate formchanger:sneak run title @s actionbar {"text": "- Change=Pickaxe -","color": "#55fddd","italic": false}
...
# 一定時間後　ツールの交換をしよう！
    execute if entity @s[scores={Nia_Sneaktime=300..}] run function formchanger:use/change/nextpickaxe
