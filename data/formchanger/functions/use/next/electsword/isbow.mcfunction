...
# ”次の交換先は　＜クロスボウ＞　だっ！　”
    execute if score @s CH_cooldown matches 0 unless predicate formchanger:sneak run title @s actionbar {"text": "- Change=Bow -","color": "#dddf55","italic": false}
...
# 一定時間後　ツールの交換をしよう！
    execute if entity @s[scores={Nia_Sneaktime=100}] run function formchanger:use/change/electsword/nextbow